...
export default function Steps(): JSX.Element {
  return (
    <div>
      ...
      <Step stepTitle="JAVASCRIPT" stepNo={5} children={<JavaScript />} slides="https://docs.google.com/presentation/d/1PQb6YxLnJ2xayiy3EOFjqiM-kXLql5DYIVZWSomLrqQ/edit?usp=sharing" />
